...
start "Talklite Frontend (3000)" /d "%~dp0frontend" cmd /k "npm run dev"
...
if exist "%NGROK_EXE%" (
    start "Talklite ngrok (3000)" cmd /k ""%NGROK_EXE%" http 3000"
) else (
    start "Talklite ngrok (3000)" cmd /k "ngrok http 3000"
)
